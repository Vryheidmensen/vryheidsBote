...
build_list = [{"Name":"Crop field","alias":["crop_field", "cropfield", "crop_fields", "farm"],"price":[("wood", 8), ("treasury", 6000)],"production":[("crops", 6)], "consumption":[],"description":"A field can be used to cultivate wheat, potato, corn, or cotton. Crops can be used for human feed, animal feed, textile manufacturing, or processing into other products."},
             ...
             "price":[("steel", 40), ("copper", 5), ("concrete", 25), ("timber", 20), ("treasury", 4000000)],
             "production":[("ships", 1)],
             "consumption":[("timber", 100), ("plastic", 50), ("glass", 30), ("steel", 200)],
             ...
             "price":[("steel", 16), ("concrete", 9), ("timber", 10), ("treasury", 140000)],
             "production":[("aluminium", 20)],
             "consumption":[("bauxite", 10)],
             ...
             "price":[("iron", 10), ("stone", 10), ("timber", 5), ("steel", 6), ("treasury", 85000)],
             "production":[("ammunition", 120)],
             "consumption":[("steel", 20), ("copper", 1)],
             ...
             "price":[("steel", 25), ("concrete", 10), ("treasury", 160000)],
             "production":[("artillery", 10)],
             "consumption":[("steel", 20)],
             ...
             "price":[("steel", 10), ("stone", 15), ("treasury", 66000)],
             "production":[("concrete", 12)],
             ...
             "price":[("stone", 15), ("steel", 6), ("timber", 10), ("treasury", 120000)],
             "production":[("firearms", 36)],
             "consumption":[("timber", 6), ("steel", 20)],
